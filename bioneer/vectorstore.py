    ...
    def __post_init__(self):
        ...
        if self.initialized == False:
            if self.type == "default":
                ...
                vectorstore = Chroma.from_texts(to_vectorize, embedding_function, metadatas=data, persist_directory=persistent)
                self.initialized = True
        elif self.initialized == True:
            vectorstore = Chroma(persist_directory=persistent, embedding_function=embedding_function)
